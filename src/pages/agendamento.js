...
function Agendamento() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await emailjs.send('service_7xoagkl', 'template_h32yvo8', templateParams, 'MBiM7SIBygzCqO4sU');
  ...
  return (
    ...
    <div className={styles.agenda}>
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <div key={pet.id} className={styles.petItem}>
            ...
            {selectedPets.includes(pet.id) && (
              ...
              >
                ...
                <option value="banho_e_tosa_completo">Banho e Tosa Completo (+ R$ 20,00)</option>
              </select>
            )}
          </div>
        ))}
        ...
        <p className={styles.totalValue}>Valor total: R$ {totalValue.toFixed(2)}</p>
