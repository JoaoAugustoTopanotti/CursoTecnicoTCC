    ...
    <div className={styles.gerenteContainer}>
      ...
      <div className={styles.gerenteMain}>
        ...
        <div className={styles.gerenteButtons}>
          ...
          <button onClick={() => router.push('/adcVendedor')}>
            Adicionar Vendedor
          </button>
          <button onClick={() => router.push('/visualizarVendedor')}>
            Visualizar Vendedores
          </button>
          <button onClick={() => router.push('/adcPet')}>
            Adicionar Pet Banho e Tosa
          </button>
          <button onClick={() => router.push('/visualizarAgenda')}>
            Visualizar Agenda
          </button>
          <button onClick={() => router.push('/faturamento')}>
            Faturamento
          </button>
        </div>
      </div>
